...
public class QContent extends EntityPathBase<Content> {
    ...
    private static final long serialVersionUID = -919340677L;
    ...
    public final NumberPath<Integer> csn = createNumber("csn", Integer.class);

    public final DateTimePath<java.time.LocalDateTime> dateTime = createDateTime("dateTime", java.time.LocalDateTime.class);

    public final BooleanPath faq = createBoolean("faq");
